        ...
        for batch_idx, (inputs, labels) in enumerate(dataloader):
            ...
            if phase == "Warm-Up":
                ...
                for name, param in model.named_parameters():
                  ...
                  if param.grad is not None and param_key in activation_dict and is_conv:
                    # print(name)
...
train_adagp(resnet, predictor, trainloader, num_epochs=20, warmup_epochs=5, device="cuda" if torch.cuda.is_available() else "cpu", fixed_output_size=10000)